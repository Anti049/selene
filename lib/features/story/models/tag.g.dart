...
extension TagQueryFilter on QueryBuilder<Tag, Tag, QFilterCondition> {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> urlIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'url',
      ));
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> urlIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'url',
      ));
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> urlEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> urlGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> urlLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> urlBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> urlStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> urlEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> urlContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'url',
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> urlMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'url',
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> urlIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'url',
        value: '',
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> urlIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'url',
        value: '',
...
extension TagQuerySortBy on QueryBuilder<Tag, Tag, QSortBy> {
  ...
  QueryBuilder<Tag, Tag, QAfterSortBy> sortByUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'url', Sort.asc);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> sortByUrlDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TagQuerySortThenBy on QueryBuilder<Tag, Tag, QSortThenBy> {
  ...
  QueryBuilder<Tag, Tag, QAfterSortBy> thenByUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'url', Sort.asc);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> thenByUrlDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'url', Sort.desc);
    });
  }
...
extension TagQueryWhereDistinct on QueryBuilder<Tag, Tag, QDistinct> {
  ...
  QueryBuilder<Tag, Tag, QDistinct> distinctByUrl({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TagQueryProperty on QueryBuilder<Tag, Tag, QQueryProperty> {
  ...
  QueryBuilder<Tag, String?, QQueryOperations> urlProperty() {
    return QueryBuilder.apply(this, (query) {

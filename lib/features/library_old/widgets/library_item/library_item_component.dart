...
import 'package:selene/features/library_old/screens/details/widgets/tag_chip.dart';
...
class _LibraryItemComponentState extends ConsumerState<LibraryItemComponent> {
  ...
  List<List<TagEntity>> get _sortedTags {
    ...
    final bool showContinueButton = ref.watch(
      libraryPreferencesProvider.select(
        (prefs) => prefs.continueReadingButton.get(),
      ),
    );
                    ...
                    Consumer(
                      builder: (context, ref, child) {
                        ...
                        return Row(
                          ...
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          spacing: showContinueButton ? 8.0 : 0.0,
                          children: [
                            IconButton(
                              icon: Icon(
                                _isExpanded
